...
class NewTripForm(forms.Form):
	origin_input = forms.CharField(max_length=200, strip=True, widget=forms.TextInput(attrs={'id': 'origin-input', 'class': 'form-control', 'placeholder': 'Enter an origin location'}))
	origin_name = forms.CharField(max_length=100, strip=True, widget=forms.HiddenInput(attrs={'data-geo': 'name'}))
	...
	destination_input = forms.CharField(max_length=200, strip=True, widget=forms.TextInput(attrs={'id': 'destination-input', 'class': 'form-control', 'placeholder': 'Enter an destination location'}))
	destination_name = forms.CharField(max_length=100, strip=True, widget=forms.HiddenInput(attrs={'data-geo': 'name'}))
